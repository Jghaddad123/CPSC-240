...
echo "Assemble Shift.asm"     # Assemble x86 module.
nasm -f elf64 -l Shift.lis -o Shift.o Shift.asm

echo ""
echo "Link the object files"

g++ -m64 -fno-pie -no-pie -o executable.out -std=c++17 main.o ValidInt.o Manager.o atoL.o Input_Array.o Shift.o Display_Array.o
